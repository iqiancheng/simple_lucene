package bs.util.tool.lucene.index;
...
public class IndexFiles {
	...
	public static IndexWriter newIndexWriter() throws IOException {
		Directory dir = FSDirectory.open(new File(Config.IndexDirectory));
		IndexWriterConfig iwc = new IndexWriterConfig(Config.VERSION, Config.ANALYZER);
	...
	public static void addIndex(Document document, IndexWriter writer) throws IOException {
		writer.addDocument(document, Config.ANALYZER);
	}
	...
	public static void addIndex(List<Document> documents, IndexWriter writer) throws IOException {
		writer.addDocuments(documents, Config.ANALYZER);
	}
	...
	public static void updateIndex(Document document, IndexWriter writer) throws IOException {
		writer.updateDocument(new Term(Config.IDNAME, document.get(Config.IDNAME)), document, Config.ANALYZER);
	}
